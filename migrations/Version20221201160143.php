 ...
 */
final class Version20221201160143 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE season ADD program_id INT DEFAULT NULL, ADD number INT NOT NULL, ADD year INT NOT NULL, ADD description LONGTEXT NOT NULL, DROP name');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE season ADD name VARCHAR(255) NOT NULL, DROP program_id, DROP number, DROP year, DROP description');
    }
}
